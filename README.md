...
2.0.23 keeps persistent panes at one true 10% layer, removes backdrop blur
...
read-state listener. Version 1.2.7 ignores stale guild-level unread booleans,
requires Discord's boolean channel unread state to agree with raw unread
counts, and skips channels that Discord marks muted.
